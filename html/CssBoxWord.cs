...
namespace System.Drawing.Html
{
        ...
        : CssRectangle
    {
        ...
        private CssBoxControl _ownerBoxC;
        ...
        internal CssBoxWord(CssBoxControl owner)
        {
            _ownerBoxC = owner;
            _word = string.Empty;
        }
        ...
        /// <param name="owner"></param>
        /// <param name="image"></param>
        public CssBoxWord(CssBoxControl owner, Image image)
            : this(owner)
        {
            Image = image;
        }
        ...
        public CssBoxControl OwnerBoxC
        {
            get { return _ownerBoxC; }
        }
        /// <summary>
