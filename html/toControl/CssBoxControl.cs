...
namespace winToWeb.html.toControl
{
    ...
    public class CssBoxControl
    {
        ...
        /// </summary>
        internal readonly static CssBoxControl Empty;
        ...
        static CssBoxControl()
        {
            ...
            PropertyInfo[] props = typeof(CssBoxControl).GetProperties();
        ...
        /// </summary>
        /// <remarks>
        /// Flag that indicates that CssTableControl algorithm already made fixes on it.
        /// </remarks>
        internal bool TableFixed;

        private List<CssBoxWord> _boxWords;
        private List<CssBoxControl> _boxes;
        private CssBoxControl _parentBox;
        private bool _wordsSizeMeasured;
        private SizeF _size;
        private PointF _location;
        private List<CssLineBoxControl> _lineBoxes;
        private List<CssLineBoxControl> _parentLineBoxes;
        ...
        private Dictionary<CssLineBoxControl, RectangleF> _rectangles = null;
        protected InitialContainerControl _initialContainer = null;
        private CssBoxControl _listItemBox;
        private CssLineBoxControl _firstHostingLineBox;
        private CssLineBoxControl _lastHostingLineBox;

        private Control _ControlView;

        #endregion

        #region Ctor

        protected CssBoxControl()
        {
            _boxWords = new List<CssBoxWord>();
            _boxes = new List<CssBoxControl>();
            _lineBoxes = new List<CssLineBoxControl>();
            _parentLineBoxes = new List<CssLineBoxControl>();
            _rectangles = new Dictionary<CssLineBoxControl, RectangleF>();
        ...
        public CssBoxControl(CssBoxControl parentBox,HtmlTag k,string d)
            : this()
        {
            _htmltag = k;
            ParentBox = parentBox;
        ...
        internal CssBoxControl(CssBoxControl parentBox, HtmlTag k)
            : this(parentBox,k,"0")
        {
         _htmltag = k;
        }
        ...
        /// Gets the • box
        /// </summary>
        public CssBoxControl ListItemBox
        {
            get
            {
                return _listItemBox;
        ...
        /// </summary>
        public List<CssBoxControl> Boxes
        {
            get { return _boxes; }
        }
        ...
        /// </summary>
        public CssBoxControl ContainingBlock
        {
            get
            {
                if (ParentBox == null)
        ...
        public float FontAscent
        {
            get
            {
                ...
                {
                    _fontAscent = CssLayoutEngineControl.GetAscent(ActualFont);
                }
                return _fontAscent;
            }
        }
        ...
        public float FontLineSpacing
        {
            get
            {
                ...
                {
                    _fontLineSpacing = CssLayoutEngineControl.GetLineSpacing(ActualFont);
                }
        ...
        public float FontDescent
        {
            get
            {
                ...
                {
                    _fontDescent = CssLayoutEngineControl.GetDescent(ActualFont);
                }
                return _fontDescent;
            }
        }
        ...
        /// </summary>
        internal CssLineBoxControl FirstHostingLineBox
        {
        ...
        /// </summary>
        internal CssLineBoxControl LastHostingLineBox
        {
        ...
        /// <summary>
        /// Gets the InitialContainerControl of the Box.
        /// WARNING: May be null.
        /// </summary>
        public InitialContainerControl InitialContainerControl
        {
        ...
        /// </summary>
        internal List<CssLineBoxControl> LineBoxes
        {
        ...
        /// </summary>
        public CssBoxControl ParentBox
        {
            ...
            set
            {
                ...
                if (value != null && !value.Boxes.Contains(this))
                {
                    ...
                    _initialContainer = value.InitialContainerControl;
                }
            }
        }
        ...
        /// </summary>
        internal List<CssLineBoxControl> ParentLineBoxes
        {
        ...
        /// </summary>
        internal Dictionary<CssLineBoxControl, RectangleF> Rectangles
        {
            get
            {
        ...
        /// </summary>
        /// <param name="b"></param>
        private void SetInitialContainer(InitialContainerControl b)
        {
            _initialContainer = b;
        }
        ...
        private int GetIndexForList()
        {
            ...
            foreach (CssBoxControl b in ParentBox.Boxes)
            {
        ...
        /// </summary>
        /// <param name="g"></param>
        private void CreateListItemBox(Control g)
        {
            if (Display == CssConstants.ListItem)
            {
                if (_listItemBox == null)
                {
                    _listItemBox = new CssBoxControl();
                    _listItemBox.InheritStyle(this, false);
                    _listItemBox.Display = CssConstants.Inline;
                    _listItemBox.SetInitialContainer(InitialContainerControl);
        ...
        /// <param name="b"></param>
        /// <returns></returns>
        internal CssBoxWord FirstWordOccourence(CssBoxControl b, CssLineBoxControl line)
        {
            ...
            {
                foreach (CssBoxControl bb in b.Boxes)
                {
        ...
        private CssBoxControl GetPreviousSibling(CssBoxControl b)
        {
            if (b.ParentBox == null)
            {
            ...
            int diff = 1;
            CssBoxControl sib = b.ParentBox.Boxes[index - diff];
        ...
        internal float GetMinimumWidth()
        {
            ...
            if (word != null)
            {
                GetMinimumWidth_BubblePadding(word.OwnerBoxC, this, ref padding);
            }
        ...
        /// <returns></returns>
        private void GetMinimumWidth_BubblePadding(CssBoxControl box, CssBoxControl endbox, ref float sum)
        {
        ...
        /// <param name="b"></param>
        /// <returns></returns>
        private void GetMinimumWidth_LongestWord(CssBoxControl b, ref float maxw, ref CssBoxWord word)
        {
        ...
        /// <returns></returns>
        internal float GetMaximumBottom(CssBoxControl startBox, float currentMaxBottom)
        {
            foreach (CssLineBoxControl line in startBox.Rectangles.Keys)
            {
        ...
        /// </summary>
        /// <returns></returns>
        internal float GetFullWidth(Control g)
        {
            float sum = 0f;
            float paddingsum = 0f;
        ...
        /// <param name="b"></param>
        /// <returns></returns>
        private void GetFullWidth_WordsWith(CssBoxControl b, Control g, ref float sum, ref float paddingsum)
        {
            if (b.Display != CssConstants.Inline)
            {
                sum = 0;
        ...
        private CssBoxControl GetNextSibling()
        {
            if (ParentBox == null)
            {
                return null; //This is initial containing block
        ...
        internal void InheritStyle(CssBoxControl godfather, bool everything)
        {
            if (godfather != null)
            {
        ...
        private float MarginCollapse(CssBoxControl a, CssBoxControl b)
        {
        ...
        public virtual void MeasureBounds(Control g)
        {
                ...
                Display == CssConstants.None)
            {
                ...
                {
                    CssBoxControl prevSibling = GetPreviousSibling(this);
                ...
                if (Display != CssConstants.TableCell &&
                    Display != CssConstants.Table) //Because their width and height are set by CssTableControl
                {
                    #region Set Width
                ...
                {
                    CssTableControl tbl = new CssTableControl(this, g);
                }
                else if (Display != CssConstants.None)
                {
                    ...
                    if (ContainsInlinesOnly())
                    {
                        ...
                        CssLayoutEngineControl.CreateLineBoxes(g, this); //This will automatically set the bottom of this block
                    }
                    else
                    {
                        CssBoxControl lastOne = null; // Boxes[Boxes.Count - 1];

                        //Treat as BlockBox
                        foreach (CssBoxControl box in Boxes)
                        {
            ...
            if (InitialContainerControl != null)
            {
                InitialContainerControl.MaximumSize = new SizeF(
                    Math.Max(InitialContainerControl.MaximumSize.Width, ActualRight),
                    Math.Max(InitialContainerControl.MaximumSize.Height, ActualBottom));
            }
        }
        ...
        /// </summary>
        /// <param name="g"></param>
        private void MeasureWordSpacing(Control g)
        {
            _actualWordSpacing = CssLayoutEngineControl.WhiteSpace(g, this);
        ...
        /// </summary>
        /// <param name="g"></param>
        internal void MeasureWordsSize(Control g)
        {
            ...
            else
            {
                ...
                {
                    bool collapse = CssBoxWordSplitterControl.CollapsesWhiteSpaces(this);
                    if (CssBoxWordSplitterControl.EliminatesLineBreaks(this)) b.ReplaceLineBreaksAndTabs();
        ...
        {
            List<CssLineBoxControl> lines = new List<CssLineBoxControl>();
            foreach (CssLineBoxControl line in Rectangles.Keys)
                lines.Add(line);

            foreach (CssLineBoxControl line in lines)
            {
            ...
            //TODO: Aquي me quede: no se mueve bien todo (probar con las tablas rojas)
        ...
        public void Paint(Control g)
        {
            ...
            PointF offset = InitialContainerControl != null ? InitialContainerControl.ScrollOffset : PointF.Empty;

            for (int i = 0; i < rects.Length; i++)
            {
                RectangleF actualRect = rects[i]; actualRect.Offset(offset);

                if (InitialContainerControl != null && HtmlTag != null && HtmlTag.TagName.Equals("a", StringComparison.CurrentCultureIgnoreCase))
                {
                    if (InitialContainerControl.LinkRegions.ContainsKey(this)) InitialContainerControl.LinkRegions.Remove(this);

                    InitialContainerControl.LinkRegions.Add(this, actualRect);
                }
        ...
        /// </summary>
        /// <param name="g"></param>
        private void PaintBorder(Control g, RectangleF rectangle, bool isFirst, bool isLast)
        {
        ...
        /// </summary>
        /// <param name="g"></param>
        private void PaintBackground(Control g, RectangleF rectangle)
        {
        ...
        /// </summary>
        /// <param name="g"></param>
        private void PaintDecoration(Control g, RectangleF rectangle, bool isFirst, bool isLast)
        {
            if (string.IsNullOrEmpty(TextDecoration) || TextDecoration == CssConstants.None || IsImage) return;

            float desc = CssLayoutEngineControl.GetDescent(ActualFont);
            float asc = CssLayoutEngineControl.GetAscent(ActualFont);
            float y = 0f;
        ...
        internal void OffsetRectangle(CssLineBoxControl lineBox, float gap)
        {
        ...
        internal void RemoveAnonymousSpaces()
        {
            ...
            {
                if (Boxes[i] is CssAnonymousSpaceBlockBoxControl || Boxes[i] is CssAnonymousSpaceBlockBoxControl)
                {
                    Boxes.RemoveAt(i);
                    i--;
                }
        ...
        private void UpdateWords()
        {
            ...
            CssBoxWordSplitterControl splitter = new CssBoxWordSplitterControl(this, Text);
            splitter.SplitWords();
