...
namespace winToWeb.html.toControl
{
    ...
    internal class CssTableControl
    {
        #region Subclasses
        ...
        public class SpacingBox
            : CssBoxControl
        {
            public readonly CssBoxControl ExtendedBox;

            public SpacingBox(CssBoxControl tableBox, ref CssBoxControl extendedBox, int startRow)
        ...
        private CssBoxControl _tableBox;
        private int _rowCount;
        private int _columnCount;
        private List<CssBoxControl> _bodyrows;
        private CssBoxControl _caption;
        private List<CssBoxControl> _columns;
        private CssBoxControl _headerBox;
        private CssBoxControl _footerBox;
        private List<CssBoxControl> _allRows;
        ...
        private CssTableControl()
        {
            _bodyrows = new List<CssBoxControl>();
            _columns = new List<CssBoxControl>();
            _allRows = new List<CssBoxControl>();
        }

        public CssTableControl(CssBoxControl tableBox, Control g)
            : this()
        {
        ...
        /// </summary>
        public List<CssBoxControl> AllRows
        {
            get { return _allRows; }
        }
        ...
        public float[] ColumnMinWidths
        {
            get
            {
                if (_columnMinWidths == null)
                {
                    ...
                    foreach (CssBoxControl row in AllRows)
                    {
                        foreach (CssBoxControl cell in row.Boxes)
                        {
        ...
        /// </summary>
        public List<CssBoxControl> Columns
        {
            get { return _columns; }
        }
        ...
        /// </summary>
        public List<CssBoxControl> BodyRows
        {
        ...
        /// WARNING: May be null
        /// </summary>
        public CssBoxControl FooterBox
        {
        ...
        /// WARNING: May be null
        /// </summary>
        public CssBoxControl HeaderBox
        {
        ...
        private void Analyze(Control g)
        {
            ...
            if (!TableBox.TableFixed)
            {
                int currow = 0;
                int curcol = 0;
                List<CssBoxControl> rows = BodyRows;

                foreach (CssBoxControl row in rows)
                {
                    ...
                    for (int k = 0; k < row.Boxes.Count; k++)
                    {
                        ...
                        CssBoxControl cell = row.Boxes[k];
            ...
            if (Columns.Count > 0)
                ...
                foreach (CssBoxControl b in AllRows) //Check trhough rows
            ...
            foreach (CssBoxControl row in AllRows)
            {
                if (row is CssAnonymousSpaceBlockBoxControl || row is CssAnonymousSpaceBoxControl) continue;
                ...
                foreach (CssBoxControl cell in row.Boxes)
                {
                    ...
                    if (spacer == null && GetRowSpan(cell) == 1)
                    {
                        ...
                        CssLayoutEngineControl.ApplyCellVerticalAlignment(g, cell);
                    }
                    else if (spacer != null && spacer.EndRow == currentrow)
                    {
                        spacer.ExtendedBox.ActualBottom = maxBottom;
                        CssLayoutEngineControl.ApplyCellVerticalAlignment(g, spacer.ExtendedBox);
                    }
                }
        ...
        /// <returns></returns>
        private float GetSpannedMinWidth(CssBoxControl row, CssBoxControl cell, int realcolindex, int colspan)
        {
            float w = 0f;
        ...
        /// <param name="cell"></param>
        /// <returns></returns>
        private int GetCellRealColumnIndex(CssBoxControl row, CssBoxControl cell)
        {
            int i = 0;

            foreach (CssBoxControl b in row.Boxes)
            {
        ...
        /// <param name="b"></param>
        /// <returns></returns>
        private float GetCellWidth(int column, CssBoxControl b)
        {
        ...
        /// </summary>
        /// <param name="b"></param>
        private int GetColSpan(CssBoxControl b)
        {
        ...
        /// </summary>
        /// <param name="b"></param>
        private int GetRowSpan(CssBoxControl b)
        {
        ...
        /// <param name="b"></param>
        /// <param name="g"></param>
        private void Measure(CssBoxControl b, Control g)
        {
            if (b == null) return;
        ...
        /// <param name="b"></param>
        /// <param name="g"></param>
        private void MeasureWords(CssBoxControl b, Control g)
        {
            if (b == null) return;
        ...
        /// </summary>
        /// <param name="b"></param>
        private int GetSpan(CssBoxControl b)
        {
        ...
        /// <returns></returns>
        private CssBoxControl CreateColumn(CssBoxControl modelBox)
        {
            return modelBox;
